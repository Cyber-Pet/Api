...
namespace CyberPet.Api.Migrations
{
    ...
    [Migration("20200325210356_AddEnul")]
    partial class AddEnul
    {
            ...
            modelBuilder.Entity("CyberPet.Api.Models.Pet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2020, 3, 25, 18, 3, 56, 218, DateTimeKind.Local).AddTicks(8437),
                            PetName = "Woody",
                            UpdateAt = new DateTime(2020, 3, 25, 18, 3, 56, 218, DateTimeKind.Local).AddTicks(8444),
            ...
            modelBuilder.Entity("CyberPet.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2020, 3, 25, 18, 3, 56, 216, DateTimeKind.Local).AddTicks(7351),
                            ...
                            UpdateAt = new DateTime(2020, 3, 25, 18, 3, 56, 217, DateTimeKind.Local).AddTicks(5060)
                        },
                        new
                        {
                            Id = new Guid("62d41afc-2e81-4b5f-9efe-be14c26d8958"),
                            CreateAt = new DateTime(2020, 3, 25, 18, 3, 56, 217, DateTimeKind.Local).AddTicks(5795),
                            Email = "gustavoreinertbsi@gmail.com",
                            Name = "Gustavo Reinert",
                            Password = "4edc2113d0937fcc5f79c2f3af0a6aa30fa8fb545bfed7d06693d2c909399600",
                            UpdateAt = new DateTime(2020, 3, 25, 18, 3, 56, 217, DateTimeKind.Local).AddTicks(5805)
                        },
                        new
                        {
                            Id = new Guid("3e3a3c48-3939-49d3-8ada-81936239a609"),
                            CreateAt = new DateTime(2020, 3, 25, 18, 3, 56, 217, DateTimeKind.Local).AddTicks(5828),
                            Email = "rrschiavo@gmail.com",
                            Name = "Renato Schiavo",
                            Password = "4edc2113d0937fcc5f79c2f3af0a6aa30fa8fb545bfed7d06693d2c909399600",
                            UpdateAt = new DateTime(2020, 3, 25, 18, 3, 56, 217, DateTimeKind.Local).AddTicks(5829)
                        });
                });
