...
namespace CyberPet.Api.Migrations
{
    ...
    [Migration("20200417231023_AddPetImageField")]
    partial class AddPetImageField
    {
            ...
            modelBuilder.Entity("CyberPet.Api.Models.Pet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2020, 4, 17, 20, 10, 23, 118, DateTimeKind.Local).AddTicks(8270),
                            PetName = "Woody",
                            UpdateAt = new DateTime(2020, 4, 17, 20, 10, 23, 118, DateTimeKind.Local).AddTicks(8295),
            ...
            modelBuilder.Entity("CyberPet.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2020, 4, 17, 20, 10, 23, 113, DateTimeKind.Local).AddTicks(512),
                            ...
                            UpdateAt = new DateTime(2020, 4, 17, 20, 10, 23, 115, DateTimeKind.Local).AddTicks(7249)
                        },
                        new
                        {
                            Id = new Guid("62d41afc-2e81-4b5f-9efe-be14c26d8958"),
                            CreateAt = new DateTime(2020, 4, 17, 20, 10, 23, 115, DateTimeKind.Local).AddTicks(9239),
                            Email = "gustavoreinertbsi@gmail.com",
                            Name = "Gustavo Reinert",
                            Password = "4edc2113d0937fcc5f79c2f3af0a6aa30fa8fb545bfed7d06693d2c909399600",
                            UpdateAt = new DateTime(2020, 4, 17, 20, 10, 23, 115, DateTimeKind.Local).AddTicks(9252)
                        },
                        new
                        {
                            Id = new Guid("3e3a3c48-3939-49d3-8ada-81936239a609"),
                            CreateAt = new DateTime(2020, 4, 17, 20, 10, 23, 115, DateTimeKind.Local).AddTicks(9283),
                            Email = "rrschiavo@gmail.com",
                            Name = "Renato Schiavo",
                            Password = "4edc2113d0937fcc5f79c2f3af0a6aa30fa8fb545bfed7d06693d2c909399600",
                            UpdateAt = new DateTime(2020, 4, 17, 20, 10, 23, 115, DateTimeKind.Local).AddTicks(9285)
                        });
                });
